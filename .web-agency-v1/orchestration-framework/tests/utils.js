/**
 * Shared utilities for web-agency skill tests
 * @module tests/utils
 */
 ...
 *
 * @example
 * const files = findMarkdownFiles('./agents');
 ...
 *
 * @example
 * const { content, error } = safeReadFile('./agent.md');
 ...
 * Handles basic key: value pairs, including values with colons
 *
