# Tests - Direction Operations

Suite de tests pour valider la structure et la qualité du skill direction-operations.

## Exécution

```bash
# Tous les tests
npm test --prefix .web-agency/skills/direction-operations

# Test spécifique
node .web-agency/skills/direction-operations/tests/validate-agents.test.js
```
...
- `DOMAINS` : Liste des 5 domaines (gouvernance, ressources, pilotage, qualite-delivery, coordination)
