...
> Dans le dossier .claude on retrouvera uniquement les commandes générique qui référence les rôles.
> Les liens symboliques vers chaque skills unitaire pour éviter de les redeclarer"
...
│   ├── frontend-developer/
│   └── ...
└── .claude/                      # Interface Claude uniquement
    ├── commands/                 # Commandes génériques
    │   ├── new-project.md
    │   ├── audit.md
    │   └── ...
    └── skills -> ../skills/      # Lien symbolique
```
