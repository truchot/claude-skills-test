...
```bash
# Backup complet
cp -r .claude/skills .claude/skills.backup.v2
...
.claude/skills/client-intake/    # 23 agents
.claude/skills/task-orchestrator/ # 16 agents

# Nouveaux skills v3.1.0
.claude/skills/ux-ui-design/      # 22 agents
.claude/skills/legal-compliance/  # 16 agents
.claude/skills/support-client/    # 16 agents
.claude/skills/commercial-crm/    # 17 agents
.claude/skills/finance-analytics/ # 17 agents
```

#### 3. Mise à Jour web-agency

```diff
# .claude/skills/web-agency/SKILL.md
...
rm -rf .claude/skills/client-intake
...
.claude/skills/direction-technique/  # v3.0.0
.claude/skills/web-dev-process/
.claude/skills/lead-dev/
.claude/skills/testing-process/
.claude/skills/frontend-developer/
.claude/skills/backend-developer/
